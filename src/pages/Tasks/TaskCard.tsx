...
export const TaskCard = ({ task, description, email, userId, taskId, showTaskDetail, status }: Props) => {
  return (
    <div onClick={() => showTaskDetail(userId, taskId)} className='border border-zinc-500 rounded-xl p-4 text-left mb-4 lg:mb-0 shadow-md hover:bg-zinc-100 cursor-pointer h-fit'>
